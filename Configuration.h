...
#define CONFIG_EXAMPLES_DIR "Creality/CR10/BigTreeTech SKR Mini E3 3.0"
...
#define STRING_CONFIG_H_AUTHOR "(ginjacoder)" // Who made the changes.
...
#define PREHEAT_5_FAN_SPEED   255 // Value from 0 to 255// @section motion
